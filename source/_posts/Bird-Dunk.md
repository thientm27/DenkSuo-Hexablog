...
updated:
tags: [2D, Casual, Arcade, Mobile, iOS, Android, Unity, Company Projects]
categories: [Game Showcase, Mobile Game]
keywords:
description: A lightweight, casual tap game featuring charming bird characters and addictive gameplay.
---

## 🐦 Bird Dunk — Fun & Addictive Dunking!

**1 player. Tap to fly. Endless fun.**

Welcome to **Bird Dunk** — a charming, cartoon-style dunking game where players control a bird to aim and score through hoops. Perfect for quick casual play sessions!

---

### 📝 Overview

Take control of an adorable bird and finesse your shots through a series of hoops. With intuitive tap-and-release mechanics, score as many baskets as possible in a row to build combos and break your personal best.

- Fast-paced and addictive gameplay
- Cute and colorful 2D visuals
- Easy to learn, hard to master!
---

### 🔗 Demo / Download

👉 [Download on Google Play](https://play.google.com/store/apps/details?id=game.onechain.birddunk&hl=en_US)
...
| Graphics               | 2D, Cartoon Style                       |
| Gameplay Mechanics     | Tap to dunk, Combo scoring              |
| Offline Support        | Fully Offline                           |
| Leaderboards           | Unity Services / Firebase               |
| Ads Monetization       | AdMob                                   |
| In-App Purchases (IAP) | Unity IAP (optional)                    |
